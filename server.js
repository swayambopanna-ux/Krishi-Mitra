...
app.get('/sensor-data', (req, res) => {
  if (!latestSensorData.timestamp) {
    return res.json({
      success: true,
      data: {
        moisture: null, temperature: null, humidity: null,
        pumpStatus: 'N/A', pumpDurationSecs: 0,
        irrigationReason: 'Waiting for NodeMCU sensor data...',
        selectedPlant: latestSensorData.selectedPlant || 'tomato',
        plantName: PLANT_DB[latestSensorData.selectedPlant || 'tomato'].name,
        timestamp: null
      }
    });
  }
